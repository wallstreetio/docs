...
## Components
* Chart Area: 
    * [Charting Tools](./chart-area/1-charting-tools.md)
    * [Plot](./chart-area/2-plot.md)
* Sidebar:
...
* Toolbar: Bespoke tools for discovering and evaluating opportunities, often used with the chart, but sometimes on their own.
    ...
    * [Fundamentals](./toolbar/4-fundamentals.md)
    * [Strategies](./toolbar/5-strategies.md)
    * [Strategy Builder](./toolbar/6-strategy-builder.md)
