...
2. Click on Indicator sets 
1. Select "Save Indicator Sets"
1. Follow the prompts
1. The indicator set will now show when Indicator sets is clicked

### Delete an indicator set
1. Click on Indicator sets 
1. Click "x" on the left side of the indicator

### Update an indicator set 
1. Click on Indicator sets
